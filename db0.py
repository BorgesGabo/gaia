...
# validates the po id is referenced via format showing po field: po_number
# this validation assures that once you pick up one po_number in po_detail's table as a po_number is referenced with the correspondant id in po's table
